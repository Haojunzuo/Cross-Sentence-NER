...
class Bert_LSTM_NerModel(nn.Module):
    def __init__(self, lstm_hidden, class_num):
        ...
        self.bert = BertModel.from_pretrained('F:\\NER Embedding\\Chinese-BERT-wwm')
    ...
    def forward(self, batch_index, batch_label=None, saveTensor=False):
        ...
        if saveTensor:
            ...
            if shape != 50:
                torch.save(self.relayTensor, './sentenceRep/train-bert-wwm-unsupervised.pt')
...
if __name__ == "__main__":
    ...
    tokenizer = BertTokenizer.from_pretrained('F:\\NER Embedding\\Chinese-BERT-wwm')
