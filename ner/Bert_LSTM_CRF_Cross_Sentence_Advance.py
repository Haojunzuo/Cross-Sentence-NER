...
class Bert_LSTM_NerModel(nn.Module):
    def __init__(self, lstm_hidden, class_num, relayTensorTrain, relayTensorDev, relayTensorTest, windowSize):
        ...
        self.bert = BertModel.from_pretrained('/home/cjh/NERCode/Chinese-BERT-wwm')
...
if __name__ == "__main__":
    ...
    scoreListAll = []
    for w in windowSize:
        relayTensorTrain = torch.load('../tensor/sentenceRep/train-mean-wwm-glyce-unsupervised.pt')
        ...
        relayTensorDev = torch.load('../tensor/sentenceRep/dev-mean-wwm-glyce-unsupervised.pt')
        ...
        tokenizer = BertTokenizer.from_pretrained('/home/cjh/NERCode/Chinese-BERT-wwm')
        ...
        model = Bert_LSTM_NerModel(lstm_hidden, len(label_2_index), relayTensorTrain, relayTensorDev, relayTensorTest, w).to(device)
